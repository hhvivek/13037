...
function do_alert($msg) 
    {
      ...
      if (isset($_POST['submit']))
      {
		...
		$queryget = mysql_query("SELECT password FROM admin WHERE username='$myusername'");
		...
		{
		do_alert("Password must be betwwen 6 & 25");
		...
		else
		{
				...
				UPDATE admin SET password='$newpassword' WHERE username='$myusername'
				");
