...
<head>
    ...
    <title><?php echo $sitename; ?> | View/Modify employee</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">View/Modify employee</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">View/Modify employee</li>
                        </ol>
                    </div>
                </div>
