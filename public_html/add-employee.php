...
if( isset($_POST['name']) )
     {
          ...
          else
          {
              ...
              if($row==0)
              {
              mysql_query("INSERT INTO `admin` (`id`, `img`, `name`, `salary`, `gender`, `dob`, `mobile`, `email`, `street`, `city`, `state`, `pcode`, `username`, `password`, `type`) VALUES (NULL, 'http://thelstera.com/user_uploads', '".$_POST['name']."', '".$_POST['salary']."', '".$_POST['gender']."', '".$_POST['dob']."', '".$_POST['mobile']."', '".$_POST['email']."', '', '', '', '', '".$_POST['username']."', '".$_POST['password']."', 'employee');");
              echo "<script type='text/javascript'>
...
<head>
    ...
    <title><?php echo $sitename; ?> | Add Employee</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Add Employee</h3>
                        <ol class="breadcrumb">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="role" value="employee" class="form-control" required>
